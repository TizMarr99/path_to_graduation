    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {artifact?.label || 'Accordatore di Ombre'}
          </p>
          <p
            style={{
              fontSize: '0.85rem',
          ...
          >
            {artifact?.description || 'Ti concede un indizio extra nel corridoio finale.'}
          </p>
        </div>
